...
const educationTimeline = [
  {
    ...
    period: "2020 - Present",
    description: "Major in Computer Science with specialization in Data Science. Current GPA: 3.8/4.0",
    tags: ["Data Structures", "Machine Learning", "Database Systems"],
    icon: GraduationCap,
  },
  {
    ...
    period: "2018 - 2020",
    description: "Completed with 95% aggregate in Mathematics, Physics, and Computer Science.",
  ...
  },
  {
    ...
    period: "2018",
    description: "Graduated with 98% aggregate and state topper in Computer Science.",
    tags: ["School Topper", "State Rank 3"],
    icon: Award,
  },
]
